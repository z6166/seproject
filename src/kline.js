        ...
        Vue.prototype.Kline = (function (stock_id,isVIP) {
                ...
                function flushRt() {
                    var vm = new Vue({
                        methods: {
                            get: function () {
                                this.$axios.get(this.baseurl + '/kline/get_rt?id=' + stockId).then(function (res) {
                                    dataRt = handleRtData(res.data.data, res.data.basePrice);
                                    flushOptionRt();
                ...
                function flushHis(interval) {
                    const vm = new Vue({
                        methods: {
                            get: function () {
                                this.$axios.get(this.baseurl + '/kline/get_his?id=' + stock_id + '&interval=' + interval).then(function (res) {
                                    dataHis = handleHistoryData(res.data.data);
                                    flushOptionHis();
